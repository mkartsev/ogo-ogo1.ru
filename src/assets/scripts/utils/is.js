...
export const isFunction = (value) => toString.call(value) === "[object Function]" || typeof value === "function"
...
export const isWindow = (value) => value != null && typeof value === "object" && "setInterval" in value
